...
// 			nodeIDs, err := r.Cache.GetNodeIDsForResource(resourcev3.ClusterType, resourceName)
// 			if err != nil {
// 				return ctrl.Result{}, errors.Wrap(err, errors.GetNodeIDForResource)
// 			}
// 			if err := r.Cache.Delete(nodeIDs, resourcev3.ClusterType, resourceName); err != nil {
...
// 	if len(nodeIDs) == 0 {
// 		// TODO: default work wrong. It's nor default, it's get all nodeIDs from all listeners
...
// 	if err := r.Cache.Update(nodeIDs, cluster, resourceName); err != nil {
